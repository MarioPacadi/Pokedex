...
import hr.algebra.pokedex.api.response.stat.Ability
import hr.algebra.pokedex.api.response.stat.Move
import hr.algebra.pokedex.api.response.stat.Sprite
import hr.algebra.pokedex.api.response.stat.Type
...
data class PokemonDetailsResponse(
    ...
    fun getStringOfAbilities() : String{
